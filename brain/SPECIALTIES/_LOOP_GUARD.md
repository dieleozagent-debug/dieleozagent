...
| **"DT-TEL-2026-007" como autoridad para 64 hilos** | **Alucinación del propio NotebookLM** — esta DT NO EXISTE en el repositorio del proyecto (verificado por escaneo forense de 124 archivos del notebook 2026-05-08). NotebookLM inventa el nombre cuando no encuentra trazabilidad real. La cita real de "64 hilos" viene de TDR Fase III (`250902_TDR EYD FASE III Lote 3 LFC-V1.pdf`) y Adenda 02 (`ADE02_PROCESO_LFC-007-2025.docx`) — ambos PRE-CONTRACTUALES, no vinculantes. | Bloquear cualquier mención de DT-TEL-2026-007 como fuente. Si el agente la ve en respuesta del Oráculo, contrastar contra AT3 §6.4 (48 hilos) y aplicar §1.2.d Prelación. |
| **"DT-SICC-2026-022" como autoridad para 64 hilos** | **Alucinación del NotebookLM** — esta DT TAMPOCO existe en el repositorio. Mismo origen que la anterior. | Bloquear. |
| **"Línea Base Maestra DT-INTG-2026-015"** citada como vinculante | El nombre puede o no existir en el repo, pero **la Línea Base de Telecomunicaciones NO es contractual** — los DTs internos LFC no prevalecen sobre AT3. | Si aparece en respuesta del Oráculo, descartar como fuente vinculante; aplicar AT3 §6.4. |
| **NotebookLM citando TDR/Adenda como vinculantes (ej. "64 hilos según TDR Fase III")** | Los TDR de licitación y Adendas del Proceso de Selección son **pre-contractuales**. Por §1.2.d (Prelación), AT3 prevalece. | Aplicar la regla de prelación: AT3 §6.4 → 48 hilos vincula. |
